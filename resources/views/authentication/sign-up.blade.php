                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            <input id="password-confirm" type="password" placeholder="Konfirmasi Password" class="form-control @error('password_confirmation') is-valid @enderror" name="password_confirmation" required autocomplete="new-password">
